...
public class Doctor extends User {
	...
	// Constructor
	public Doctor(int userId, int doctorId, String doctorName, String doctorEmail, String doctorEncryptedPassword,
			String userSalt, String doctorIdentification) {
	...
	public void setDoctorIdNumber(String doctorIdentification) {
		this.doctorIdentification = doctorIdentification;
	}
